...
describe("routes : advertisements", () => {
    ...
    describe("POST /advertisements/create", () => {
        const options = {
          ...
          form: {
            title: "pepsi ads",
            description: "What's your favorite pepsi ad?"
          }
        };
        ...
        it("should create a new advertisement and redirect", (done) => {
          request.post(options,
            (err, res, body) => {
              Advertisement.findOne({where: {title: "pepsi ads"}})
              .then((advertisement) => {
                expect(res.statusCode).toBe(303);
                expect(advertisement.title).toBe("pepsi ads");
                expect(advertisement.description).toBe("What's your favorite pepsi ad?");
                done();
              })
              .catch((err) => {
                console.log(err);
